...
lang.alert_consent = "Vous devez cocher la case pour continuer".
...
if (mobile_session) {
  ...
  var variable_text = "activez-les en appuyant sur la flèche gauche, bas ou milieu de votre clavier"
}
...
lang.welcome1_box3 = "Vous disposez de trois boutons de réponse : " + texte_variable ;
...
// 
lang.post1_box1 = "Maintenant, vous allez effectuer un premier petit test de mémoire."
lang.post1_box2 = "Vous allez à nouveau voir toutes les images (3 fois chacune) et vous devrez simplement vous rappeler quel était le bon bouton pendant le jeu principal !" +
  "<br>Aucun retour ne sera donné concernant l'exactitude de vos réponses."
if (mobile_session) {
  lang.post1_continue = "<b>Tap ici pour continuer...</b>"
} else {
  lang.post1_continue = "<b>Flèche droite pour continuer...</b>"
}
...
if (mobile_session) {
  ...
  lang.fullscreen_msg = "<p>L'expérience passera en mode plein écran lorsque vous appuierez sur le bouton ci-dessous !" +
    "<br>Vous pouvez quitter le mode plein écran à tout moment en utilisant la touche F11 (ou ESC), et y revenir en utilisant également la touche F11.<br><br>" +br>
...
lang.attn_check = [{
  invite : "Combien de boutons de réponse pouvez-vous utiliser ?",
  buttons : ['2', '3', '4', '5']
},
{
  invite : 'Quel est le but du jeu?',
  buttons : ['Dire quelles images vous aimez', 'Répondre toujours avec le même bouton', 'Trouver le bouton correct pour chaque image']
},
{
  invite : "Choisissez l'affirmation vraie",
...
},
{
  ...
  boutons : ["trop facile", "facile", "équilibré", "difficile", "trop difficile"]
},
{
  invite : "Quel est le but de ce premier test de mémoire?",
  boutons : ['Répondre uniquement à des catégories spécifiques', 'Se souvenir de la bonne réponse pour chaque image']
},
{
  invite : "Quel est l'objectif de ce deuxième test de mémoire ?",
...
// iLOC4
lang.ieLOC = {
  préambule : "Les affirmations suivantes peuvent s'appliquer plus ou moins à vous. Dans quelle mesure pensez-vous que chaque affirmation s'applique ou s'est appliquée à vous personnellement ?",
...
},
{
  ...
  boutons : ["regarder la TV, complètement", "regarder la TV, légèrement", "indifférent", "surfer sur le Web, légèrement", "surfer sur le Web, complètement"],
},
{
  invite : 'Dans un casino, préférez-vous jouer au poker ou aux machines à sous?',
  boutons : ["machine à sous, complètement", "machine à sous, un peu", "indifférent", "poker, un peu", "poker, complètement"], 
},
{
  prompt : "En général, diriez-vous que vous êtes meilleur pour parler ou écouter ?",
  boutons : ["parler, complètement", "parler, légèrement", "indifférent", "écouter, légèrement", "écouter, complètement"]
}
]
...
{
  invite : "Seriez-vous d'accord pour la refaire un autre jour?",
...
lang.ftp_start = {
  divs : [
    {
      texte : "Super. Nous reviendrons au jeu d'apprentissage dans quelques minutes pour vérifier si vous pouvez vous souvenir des associations que vous venez d'apprendre.",
    },
    {
      texte : "Mais pour l'instant, nous allons faire un test très simple de 'Finger tapping'.<br>Dans ce test, vous allez utiliser 4 touches de votre clavier : les touches 1, 5, 6 et 0 situées <u>au-dessus des lettres</u> comme indiqué en bleu dans l'image ci-dessous (n'utilisez pas le pavé numérique)",
    ...
    {
      texte : "Selon l'épreuve, votre <b>but</b> sera d'<b>alterner le plus rapidement possible</b> entre les touches 0 et 1, ou 5 et 6. En utilisant soit votre index gauche <u>ou</u> droit.",
    },
  ],
  continuez : 'Cliquez ici pour voir une courte démo'
}
